...
oracle --dry-run summary --files-report --engine browser --model gpt-5.5-pro \
  ...
  --slug "claude smoke implementation plan" \
  -p "Create a small implementation plan to harden these cart and scheduler utilities after reviewing the attached code. Include prioritized fixes and tests. This is a smoke test, but give a real, varied planning response." \
